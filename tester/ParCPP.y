...
Exp15 : 'true' { AbsCPP.ETrue }
      ...
      | '(' Exp ')' { $2 }
Exp14 :: { Exp }
Exp14 : Exp15 '++' { AbsCPP.EPostIncr $1 }
      | Exp15 '--' { AbsCPP.EPostDecr $1 }
      | Exp15 { $1 }
Exp13 :: { Exp }
Exp13 : '++' Exp14 { AbsCPP.EPreIncr $2 }
      | '--' Exp14 { AbsCPP.EPreDecr $2 }
      | Exp14 { $1 }
Exp12 :: { Exp }
...
Exp11 : Exp11 '+' Exp12 { AbsCPP.EPlus $1 $3 }
      ...
      | Exp12 { $1 }
Exp9 :: { Exp }
Exp9 : Exp10 '<' Exp10 { AbsCPP.ELt $1 $3 }
     | Exp10 '>' Exp10 { AbsCPP.EGt $1 $3 }
     | Exp10 '<=' Exp10 { AbsCPP.ELtEq $1 $3 }
     | Exp10 '>=' Exp10 { AbsCPP.EGtEq $1 $3 }
     | Exp10 { $1 }
Exp8 :: { Exp }
Exp8 : Exp9 '==' Exp9 { AbsCPP.EEq $1 $3 }
     | Exp9 '!=' Exp9 { AbsCPP.ENEq $1 $3 }
     | Exp9 { $1 }
Exp4 :: { Exp }
