...
compileExp (EType t e) = case e of
    ETrue       -> emit "iconst_1"
    ...
    EApp (Id i) es -> do
      ...
      where typ (Type_int)    = "I"
            ...
            typ (Type_void)   = "V"
            typ (Type_bool)   = "Z"
            typArgs = concat $ map (\(EType t' _) -> typ t') es
    -- Unary arithmetics
    EPostIncr e'@(EType t' (EId i))    -> do
        compileExp e'
        a <- lookupVar i
        case t' of
            Type_int -> do
    ...
    EPreIncr e'@(EType t' (EId i))    -> do
        ...
        case t' of
            Type_int -> do
                ...
                emit $ "dup"
                emit $ "istore " ++ show a
    EPreDecr  e     -> error "Not defined: EPreDecr"
    -- Binary arithmetics
    ...
    EAss  (EType _ (EId i)) e2  -> do
        ...
        case t of
            ...
            Type_bool -> do
                emit $ "dup"
                emit $ "istore " ++ show a
compileExp e = error $ "Not EType: " ++ show e
