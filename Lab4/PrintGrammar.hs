...
instance Print Def where
  prt i e = case e of
    DDef id ids exp -> prPrec i 0 (concatD [prt 0 id, prt 0 ids, doc (showString "="), prt 0 exp])
  prtList _ [] = (concatD [])
...
instance Print Exp where
  prt i e = case e of
    ...
    ELt exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString "<"), prt 2 exp2])
    EIf exp1 exp2 exp3 -> prPrec i 0 (concatD [doc (showString "if"), prt 1 exp1, doc (showString "then"), prt 1 exp2, doc (showString "else"), prt 0 exp3])
